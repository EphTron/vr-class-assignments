...
class Hinge(avango.script.Script):
    ...
    def my_constructor( self    
        ...
        self.hinge_geometry = _loader.create_geometry_from_file("hinge_segment_"+str(self.id), 
        ...
        self.hinge_transform = avango.gua.nodes.TransformNode(Name = "hinge_transform_"+str(self.id))
    ...
    def sf_rot_value_changed(self):
        ...
        self.rot_value = max(min(self.rot_value,self.rot_constraint[1]), self.rot_constraint[0])
